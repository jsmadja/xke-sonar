 ...
 * MA 02111-1307, USA.
 *
 * $Id: HorizontalDateAxis.java,v 1.1.1.1.2.4 2000/11/27 23:24:54 dgilbert Exp $
 */
  ...
  public void autoAdjustRange() {
    if (plot!=null) {
      if (plot instanceof HorizontalValuePlot) {
        ...
        long upper = hvp.getMaximumHorizontalDataValue().longValue();
        long lower = hvp.getMinimumHorizontalDataValue().longValue();
