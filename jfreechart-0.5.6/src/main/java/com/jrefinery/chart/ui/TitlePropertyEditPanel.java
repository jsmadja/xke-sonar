 ...
 *
 * File:            TitlePropertyEditPanel.java
 ...
 * MA 02111-1307, USA.
 *
 * $Id: TitlePropertyEditPanel.java,v 1.1.1.1.2.2 2000/11/14 21:29:07 dgilbert Exp $
 */
...
public class TitlePropertyEditPanel extends JPanel implements ActionListener {
  ...
  public TitlePropertyEditPanel(StandardTitle title) {
    ...
    fontfield = new FontDescriptionTextField(titleFont);
