 ...
 *
 * File:            ChartPropertyEditPanel.java
 ...
 * MA 02111-1307, USA.
 *
 * $Id: ChartPropertyEditPanel.java,v 1.1.1.1.2.2 2000/11/14 21:29:06 dgilbert Exp $
 */
...
public class ChartPropertyEditPanel extends JPanel implements ActionListener {
  ...
  /**
   * Sets the properties of the specified chart to match the properties defined on this panel.
   */
  public void setChartProperties(JFreeChart chart) {
    titlePropertiesPanel.setTitleProperties(chart.getTitle());
    legendPropertiesPanel.setLegendProperties(chart.getLegend());
    plotPropertiesPanel.setPlotProperties(chart.getPlot());

    chart.setAntiAlias(this.getAntiAlias());
    chart.setChartBackgroundPaint(this.getBackgroundPaint());
  }
