 ...
 *
 * File:            LegendPropertyEditPanel.java
 ...
 * MA 02111-1307, USA.
 *
 * $Id: LegendPropertyEditPanel.java,v 1.1.1.1.2.2 2000/11/14 21:29:07 dgilbert Exp $
 */
...
class LegendPropertyEditPanel extends JPanel
  ...
  public LegendPropertyEditPanel(Legend legend) {
    ...
    button.addActionListener(this);
    interior.add(new FontDescriptionTextField(seriesFont));
    interior.add(button);
