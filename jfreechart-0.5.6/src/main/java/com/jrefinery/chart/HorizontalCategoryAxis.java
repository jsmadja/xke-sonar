 ...
 *
 * File:            HorizontalCategoryAxis.java
 ...
 * MA 02111-1307, USA.
 *
 * $Id: HorizontalCategoryAxis.java,v 1.1.1.1.2.3 2000/11/25 11:26:08 dgilbert Exp $
 */
...
public class HorizontalCategoryAxis extends CategoryAxis implements HorizontalAxis {
   ...
   */
  public HorizontalCategoryAxis(String label, Font labelFont, Paint labelPaint, Insets labelInsets,
                       boolean showCategoryLabels, boolean verticalCategoryLabels,
                       Font categoryLabelFont, Paint categoryLabelPaint, Insets categoryLabelInsets,
  ...
  public void refreshTicks(Graphics2D g2, Rectangle2D drawArea, Rectangle2D plotArea) {
    ...
    float xx = 0.0f;
    float yy = 0.0f;
    Iterator iterator = categoryPlot.getDataSource().getCategories().iterator();
    while (iterator.hasNext()) {
  ...
  public Rectangle2D reserveAxisArea(Graphics2D g2, Plot plot, Rectangle2D drawArea,
    ...
    return new Rectangle2D.Double(drawArea.getX(), drawArea.getMaxY()-labelHeight-tickLabelHeight,
                                  drawArea.getWidth()-reservedWidth, labelHeight+tickLabelHeight);
  }
